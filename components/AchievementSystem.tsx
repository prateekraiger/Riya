...
export const AchievementSystem: React.FC<AchievementSystemProps> = ({
  ...
  const loadAchievements = async () => {
    ...
    try {
      ...
      const achievementData = await getUserPreference(user.id, 'achievements') || {};
  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Header */}
          <div className="p-6 border-b border-border bg-gradient-to-r from-yellow-500/10 to-orange-500/10">
      ...
      <AnimatePresence>
        {newlyUnlocked.map((achievement, index) => (
          <motion.div
            ...
            className="fixed bottom-4 right-4 bg-gradient-to-r from-yellow-500 to-orange-500 text-white p-4 rounded-lg shadow-lg z-60"
