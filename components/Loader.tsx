...
const Loader: React.FC = () => {
  ...
  const wrapperStyle = {
    ...
    "--cube-color": "rgba(255, 93, 143, 0.2)", // Semi-transparent pink for cube background
    "--highlight-color": "#FF5D8F", // Main pink for highlights and text
    "--cube-width": "48px",
    "--cube-height": "48px",
    "--font-size": "1.8em",
  ...
  return (
    ...
    // Updated background to a light pink gradient
    <div className="flex items-center justify-center min-h-screen w-full bg-gradient-to-br from-[#FFF1F0] to-[#FFD6E0]">
      ...
      <style>
        {`
          ...
          .wrapper-grid {
            ...
            font-weight: 800;
            color: var(--highlight-color); /* Changed to make text visible */
          }
          ...
          .face {
            ...
            height: var(--cube-height);
            background-color: var(--cube-color); /* Initial background color from variable */
          ...
          /* Box shadows for specific faces, updated to pink shades */
          .face-left,
          .face-right,
          .face-back,
          .face-front {
            box-shadow: inset 0 0 2px 1px rgba(255, 93, 143, 0.3), inset 0 0 12px 1px rgba(255, 93, 143, 0.3);
          }
          ...
          @keyframes face-glow {
            0%, 50%, 100% {
              color: var(--highlight-color); /* Ensure text is visible even when not glowing */
              filter: none;
            }
            30% {
              color: #fff; /* White text for the glow effect */
          ...
          @keyframes edge-glow {
            ...
            30% {
              box-shadow: 0 0 2px 0px var(--highlight-color); /* Updated to use highlight color for edge glow */
            }
          }
        `}
      </style>
